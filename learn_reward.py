...
def main(argv):
    ...
    diffusion = Diffusion(state_dim, x_min, x_max, 
                          FLAGS.hidden_dim, FLAGS.num_hidden_layers, FLAGS.lr, FLAGS.device)
    ...
    for epoch in range(FLAGS.epochs):
        ...
        if (epoch+1)%1000==0:
            print(f'Epoch: {epoch+1}/{FLAGS.epochs}, Diffusion loss: {(epoch_loss/batches):.4f}')
